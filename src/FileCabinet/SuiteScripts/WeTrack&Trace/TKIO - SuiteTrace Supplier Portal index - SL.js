...
define(['N/search', 'N/ui/serverWidget'],
    ...
    (search, serverWidget) => {
        ...
        const onRequest = (scriptContext) => {
            try {
                ...
                let form = serverWidget.createForm({
                    title: "SuiteTrace Supplier Portal",
                    hideNavBar: false
                });
        ...
        const getHTMLTemplate = () => {
            try {
                let content = '';
                let cssFile = getFileURL('app.449aec07.css');
                let chunkCssFile = getFileURL('chunk-vendors.30dc7754.css');
                let appJSFile = getFileURL('app.723a1298.js');
                let chunkFile = getFileURL('chunk-vendors.e247b98b.js');
